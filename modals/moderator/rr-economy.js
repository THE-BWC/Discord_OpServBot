...
module.exports = {
    data: {
        custom_id: 'rr-modal-economy'
    },

    execute: async function (client, interaction) {
        if (interaction.customId === 'rr-modal-economy') {
            ...
            const rapidResponseRole = interaction.guild.roles.cache.find(role => role.name === 'SC RR Economy');
